    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="col-sm-6">         
                ...
                <div>
                    ...
                    <p><?php echo $profilModel->getGender();?></p>
                </div>
                <div>
        ...
        <div class="col-md-6">         
            <div class="float-btn-profil">
                ...
                <div class="btn-profil"><?php if(Yii::app()->user->id == $profilModel->idPengguna)echo CHtml::link('Riwayat Tryout',array('/tryout/answerSheet/history'),array('class'=>'btn btn-primary'));?></div>
                <div class="btn-profil"><?php if(Yii::app()->user->id == $profilModel->idPengguna)echo CHtml::link('Ubah Password',array('changePassword'),array('class'=>'btn btn-primary'));?></div>
            </div>
        </div>     
    </div>
</div>
