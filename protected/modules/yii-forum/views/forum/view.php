...
$newthread = $forum->is_locked?'':'<div class="newthread" style="float:right;">'. CHtml::link('Thread Baru', array('/forum/thread/create', 'id'=>$forum->id),array('class'=>'btn btn-primary')) .'</div>';
